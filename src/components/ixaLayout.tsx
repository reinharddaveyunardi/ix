...
const CarouselParentSchool = dynamic(() => import("./CarouselParentSchool"));
...
export default function IXA({ children, title }: Props) {
  return (
    <div className="flex flex-col bg-[#2e281b91] top-0 gyahegi">
